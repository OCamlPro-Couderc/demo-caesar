...
This library serves as support material for C and C++ developpers to get started with TIS CV.\
[Open the tutorial](https://docs.tis-cv.com/tutorial "TIS CV tutorial")

## TIS CV

TIS CV is an online source code analyzer that continuously detects undefined behaviors in C and C++ programs (i.e. crash, arbitrary code execution, etc.).
